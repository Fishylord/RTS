...
// The raw per-car metrics are saved in a JSON array.
/////////////////////////////////////////////
...
use criterion::black_box; // Optional use of Criterion to black_box critical computations
...
async fn main() {
    ...
    let final_metrics = format!(
        ...
        avg_wait, avg_drive, avg_simulated, avg_wall, avg_queue, avg_cpu
    );
    ...
    // Prepare a JSON array of all car metrics (raw data only, no average row).
